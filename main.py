...
tweet_contents = open("tweet_contents.txt","r")

#TODO:
    #reply interface with api  
    #reply text generation
    #new tweet detection/reply
    #
...
def send_tweet(payload_text):
    ...
    with open('log.txt', 'a') as log:
        log.write(json.dumps(json_response, indent=4, sort_keys=True))
    
    
def generate_reply_text():
    pass
    #2d tuple with text; loop thru and selsct 1 word from each
